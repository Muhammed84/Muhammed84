...
public class LevelThreeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: levelThreeActivity");
        setToolbar();
        ...
        mCheckbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyJasonSaver myJasonSaver = new MyJasonSaver(LevelThreeActivity.this);


                if (mCheckbox.isChecked()) {
                    save(checkBoxKeyArrayList.get(index).getGermanWord(), true);
                    myJasonSaver.addFavorite(words);
                    //FavoritesItemsActivity.checkState = true;

                    Toast.makeText(LevelThreeActivity.this, getResources().getString(R.string.add_favr),
                    ...
                    //FavoritesItemsActivity.checkState = false;


                    Toast.makeText(LevelThreeActivity.this, getResources().getString(R.string.remove_favr),
                            Toast.LENGTH_SHORT).show();

                }
                /*
                if (checkItemsFavorites(words) ){
                    save(checkBoxKeyArrayList.get(index).getGermanWord(), true);
                }else {
                    save(checkBoxKeyArrayList.get(index).getGermanWord(), false);
                }
    ...
    @Override
    public void onClick(View v) {
        Log.d(TAG, "onClick: levelThreeActivity");
        int id = v.getId();
    ...
    public void setWords() {
        Words words1 = new Words("der", "Wohnort", "مكان السكن");
        Words words2 = new Words("der", "Lehrer", "مُعلم");
        Words words3 = new Words("der", "Hunger", "الجوع");
        Words words4 = new Words("der", "Durst", "العطش");
        Words words5 = new Words("der", "Verkäufer", "بائع");
        Words words6 = new Words("die", "Musik", "موسيقى");
        Words words7 = new Words("die", "Firma", "شركة");
        Words words8 = new Words("die", "Straße", "شارع");
        Words words9 = new Words("die", "Stadt", "مدينة");
        Words words10 = new Words("die", "E-mail", "بريد الكتروني");
        Words words11 = new Words("das", "Telefon", "هاتف");
        Words words12 = new Words("das", "Formular", "إستمارة");
        Words words13 = new Words("das", "Jahr", "سنة");
        Words words14 = new Words("das", "Alter", "العمر");
        Words words15 = new Words("das", "Mehl", "طحين");
    ...
    public void setToolbar() {
        Log.d(TAG, "setToolbar: levelThreeActivity");
        ...
        actionBar.setTitle("Level Three");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        Log.d(TAG, "onCreateOptionsMenu: levelThreeActivity");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Log.d(TAG, "onOptionsItemSelected: levelThreeActivity");
